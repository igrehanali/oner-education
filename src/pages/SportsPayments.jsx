...
import sports from "../../public/icons/sports.png";
const SportsPayments = () => {
  const Unidata = [
    {
      uni: "Basket Bll Annual Sports",
        ...
        {Unidata.map((unidata, index) => (
          ...
          >
            <div className="flex  items-center gap-4 mt-4 ml-5 ">
              <img src={sports} className="w-[41px] h-[41px]" />
