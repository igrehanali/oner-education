    ...
    <div className="w-full h-full p-2 ">
      <div className="flex justify-between items-center ">
        <div className="flex items-center justify-start gap-8 ">
          ...
          <h1 className="font-medium md:text-[36px] ">University Payments</h1>
        </div>
        <NavLink to="/app/UniFees">
          <div className="w-[43px] h-[39.16px] rounded-md mr-4 bg-[#571f6f] flex items-center justify-center">
